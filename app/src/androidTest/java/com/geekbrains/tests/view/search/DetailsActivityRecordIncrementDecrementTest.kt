...
class DetailsActivityRecordIncrementDecrementTest {
  ...
  /*  @Rule
    ...
    @Test
    fun detailsActivityRecordIncrementDecrementTest() {
        ...
        countTextView.check(matches(withText("Number of results: 1")))

        val decrementlButton = onView(
            allOf(
        ...
        decrementlButton.perform(click())
        decrementlButton.perform(click())
